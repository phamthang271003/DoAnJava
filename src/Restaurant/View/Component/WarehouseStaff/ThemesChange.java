...
public class ThemesChange extends JPanel {
    ...
    private void init() {
        ...
        JButton buttonLight = new JButton(createIcon("Icons/Warehouse/light.svg"));
        JButton buttonDark = new JButton(createIcon("Icons/Warehouse/dark.svg"));
        ...
        if (dark != FlatLaf.isLafDark()) {
            if (dark) {
                EventQueue.invokeLater(() -> {
                    ...
                    FlatLaf.updateUI();
                    FormWareHouseStaff.updateTempFormUI();
