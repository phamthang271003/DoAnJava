...
public class MainForm extends JPanel {
    ...
    private JPanel createHeader() {
        ...
        cmdMenu.addActionListener(e -> {
            FormWareHouseStaff.showMenu();
        });
        cmdUndo.addActionListener(e -> {
            FormWareHouseStaff.undo();
        });
        cmdRedo.addActionListener(e -> {
            FormWareHouseStaff.redo();
        });
        cmdRefresh.addActionListener(e -> {
            FormWareHouseStaff.refresh();
        });
    ...
    private void checkButton() {
        cmdUndo.setEnabled(FormWareHouseStaff.getForms().isUndoAble());
        cmdRedo.setEnabled(FormWareHouseStaff.getForms().isRedoAble());
        cmdRefresh.setEnabled(FormWareHouseStaff.getForms().getCurrent() != null);
    }
